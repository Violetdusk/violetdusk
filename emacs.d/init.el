...
before packages are loaded."
  ...
  ;; NOTE(VDSK) Settings for Copilot. href: https://github.com/zerolfx/copilot.el
  (defun v-copilot-tab()
    (interactive)
  ...
  (with-eval-after-load 'company
    ...
    (define-key company-mode-map (kbd "<tab>") 'v-copilot-tab)
    (define-key company-mode-map (kbd "TAB") 'v-copilot-tab)
    (define-key company-active-map (kbd "<tab>") 'v-copilot-tab)
    (define-key company-active-map (kbd "TAB") 'v-copilot-tab))
